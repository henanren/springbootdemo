...
public class AnnotatedBean {
	...
	// logger.info("timeout2 is {}", timeout);
	// logger.info("batch is {}", batch);
	//
	// logger.info("Keys for config: {}", config.getPropertyNames());
	// logger.info("Keys for anotherConfig: {}",
	// anotherConfig.getPropertyNames());
	// }
	...
	// logger.info("[someChangeHandler]Changes for namespace {}",
	...
	// logger.info("[anotherChangeHandler]Changes for namespace {}",
	// changeEvent.getNamespace());
	// for (String key : changeEvent.changedKeys()) {
	// ConfigChange change = changeEvent.getChange(key);
	// logger.info("[anotherChangeHandler]Change - key: {}, oldValue: {},
	// newValue: {}, changeType: {}",
